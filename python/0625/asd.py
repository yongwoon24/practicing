...
match(select_theme):
    case 1:
        driver.find_element(By.CSS_SELECTOR, '#content > div.article > div.section > div.section_sise_top > ul > li.tab1 > a').click()
    case 2:
        driver.find_element(By.CSS_SELECTOR, '#content > div.article > div.section > div.section_sise_top > ul > li.tab2 > a').click()
    case 3:
        driver.find_element(By.CSS_SELECTOR, '#content > div.article > div.section > div.section_sise_top > ul > li.tab3 > a').click()
    case 4:
        driver.find_element(By.CSS_SELECTOR, '#content > div.article > div.section > div.section_sise_top > ul > li.tab4 > a').click()
    case _:
        print('1 ~ 4 숫자를 입력하세요')
time.sleep(5)
...
# match(select_theme):
#     case 1:
#         excel_filename = 'stock_data_toptradeamount.xlsx'
#     case 2:
#         excel_filename = 'stock_data_topincreased.xlsx'
#     case 3:
#         excel_filename = 'stock_data_topdecreased.xlsx'
#     case 4:
#         excel_filename = 'stock_data_toptotalprice.xlsx'
